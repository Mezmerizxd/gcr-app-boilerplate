...
export const Drawer = ({ title, children, isOpen, onClose, renderFooter, size = 'md' }: DrawerProps) => {
  return (
    <Transition.Root show={isOpen} as={React.Fragment}>
      <Dialog as="div" static className="fixed inset-0 overflow-hidden z-40" open={isOpen} onClose={onClose}>
            ...
            >
              <div className={clsx('w-screen', sizes[size])}>
                <div className="h-full  flex flex-col bg-background shadow-xl">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="ml-3 h-7 flex items-center">
                          ...
                          >
                            ...
                            <MdOutlineExitToApp className="h-6 w-6" aria-hidden="true" />
                          </button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-shrink-0 px-4 py-4 flex justify-end space-x-2">{renderFooter()}</div>
                </div>
              </div>
            </Transition.Child>
          </div>
